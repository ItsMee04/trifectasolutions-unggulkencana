...
class CompailReportController extends Controller
{
    ...
    {
        // Target file JRXML
        $input_jrxml = resource_path('reports/CetakLaporanNampanPerBaki.jrxml');
        ...
        try {
            ...
            return response()->json([
                'message' => 'Kompilasi CetakLaporanNampanPerBaki.jrxml berhasil!',
                'output_file' => $output_dir . '/CetakLaporanNampanPerBaki.jasper'
            ]);
        } catch (\Exception $e) {
