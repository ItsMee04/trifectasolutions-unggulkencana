...
class CompailReportController extends Controller
{
    ...
    {
        // Target file JRXML
        $input_jrxml = resource_path('reports/CetakLaporanNampan.jrxml');
        ...
        try {
            ...
            return response()->json([
                'message' => 'Kompilasi CetakLaporanNampan.jrxml berhasil!',
                'output_file' => $output_dir . '/CetakLaporanNampan.jasper'
            ]);
        } catch (\Exception $e) {
