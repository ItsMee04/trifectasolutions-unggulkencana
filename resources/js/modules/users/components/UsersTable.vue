    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <div class="card-title mb-0"><b>DAFTAR USERS</b></div>
                ...
                <div class="table-responsive">
                    <table class="table text-nowrap table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr v-else v-for="(item, index) in paginatedUsers" :key="item.id">
                                ...
                                <td>
                                    <span v-if="item.role_id == null" class="badge bg-danger">
                                        ROLE BELUM DI TAMBAHKAN
                                    </span>
                                ...
                                <td>
                                    <span v-if="item.email == null" class="badge bg-danger">
                                        EMAIL BELUM DI TAMBAHKAN
                                    </span>
                                    <span v-else class="badge bg-secondary">
                                        {{ item.email }}
                                    </span>
