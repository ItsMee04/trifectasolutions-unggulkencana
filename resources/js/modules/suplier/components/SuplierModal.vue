                        ...
                        <div class="content">
                            <div
                                ...
                                <div class="page-title">
                                    <h4>{{ isEdit ? 'EDIT SUPLIER' : 'TAMBAH SUPLIER' }}</h4>
                                </div>
                                ...
                                <form @submit.prevent="handleSubmit">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama"
                                            v-model="formSuplier.nama" placeholder="Masukkan nama"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kontak"
                                            v-model="formSuplier.kontak" placeholder="Masukkan kontak"
                                            :class="{ 'is-invalid': errors.kontak }">
                                        <div class="invalid-feedback" v-if="errors.kontak">{{ errors.kontak }}</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="alamat" class="form-label">Alamat</label>
                                        <textarea class="form-control" v-model="formSuplier.alamat" placeholder="Masukkan alamat"
                                            :class="{ 'is-invalid': errors.alamat }" id="alamat" cols="4" rows="4"></textarea>
...
const { isLoading, formSuplier, errors, isEdit, submitSuplier } = useSuplier();
