<template>
    <teleport to='body'>
        <div class="modal fade" id="pembelianviewModal" tabindex="-1" aria-labelledby="pembelianviewModalLabel"
            aria-hidden="true">
                                            ...
                                            <div class="table-responsive no-pagination mb-3">
                                                <table class="table" id="transaksiProduk">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr v-for="(item, index) in selectedTransaction?.pembeliandetail"
                                                            :key="index">
                                                        ...
                                                        <tr
                                                            v-if="!isLoading && (!selectedTransaction?.pembeliandetail || selectedTransaction.pembeliandetail.length === 0)">
                                                        ...
                                                        <ul class="border-1 rounded-1">
                                                            <li class="border-bottom">
                                                                ...
                                                                <h5 class="text-danger">
                                                                    {{
                                                                    formatRupiah(selectedTransaction?.pembeliandetail[0]?.total)
                                                                    }}
                                                                </h5>
                                                            </li>
                                                            <!-- <li class="border-bottom">
