    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <div class="card-title mb-0"><b>DAFTAR TRANSAKSI PEMBELIAN</b></div>
            ...
            <div class="card-body">
                    ...
                    <table class="table text-nowrap table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">PELANGGAN / SUPLIER</th>
                        ...
                        <tbody>
                            ...
                            <tr v-else-if="paginatedPembelian.length === 0">
                                <td colspan="7" class="text-center">Tidak ada data.</td>
                            </tr>
                            <tr v-else v-for="(item, index) in paginatedPembelian" :key="item.id">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <div class="lh-1">
                                                <span>PEMBELIAN {{ item.jenis }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                ...
                <div v-if="filteredPembelian.length > 0" class="d-flex justify-content-between align-items-center p-3">
                    <div class="text-muted small">
                        Showing {{ (currentPage - 1) * itemsPerPage + 1 }} to
                        {{ Math.min(currentPage * itemsPerPage, filteredPembelian.length) }} of
                        {{ filteredPembelian.length }} entries
                    </div>
