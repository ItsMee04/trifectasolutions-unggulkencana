    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table text-nowrap table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr v-else v-for="(item, index) in paginatedProduk" :key="item.id">
                                ...
                                <td>
                                    <div class="productimgname">
                                        <a href="javascript:void(0);" class="product-img stock-img">
                                            <img :src="item.image ? `/storage/images/produk/${item.image}?t=${new Date().getTime()}` : BASE_DEFAULT_IMAGE_URL"
                                                :alt="item.nama">
                                        </a>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <div class="lh-1">
                                                <span>{{ formatRupiah(item.harga?.harga) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                ...
                <div v-if="filteredProduk.length > 0" class="d-flex justify-content-between align-items-center p-3">
                    <div class="text-muted small">
                        Showing {{ (currentPage - 1) * itemsPerPage + 1 }} to
                        {{ Math.min(currentPage * itemsPerPage, filteredProduk.length) }} of
...
<style>
/* Perkecil ruang di dalam cell tabel secara khusus untuk kolom barcode */
.barcode-column {
...
.barcode-style {
    ...
    /* Lebar diperkecil */
    height: 20px;
    /* Tinggi dikunci sangat tipis */
    object-fit: stretch;
    /* Memaksa batang barcode tetap terlihat meski tipis */
...
.barcode-text {
    ...
    /* Font sangat kecil */
    line-height: 1;
    /* Menghilangkan spasi antar baris */
    margin-top: 1px;
    /* Jarak minimal dengan batang barcode */
    color: #333;
}
</style>
